...
# =============================================================================
# Compare Bet Configuration (彩头系统)
# =============================================================================
class CompareBet:
    MIN_BET = 10                   # 最小彩头
    MAX_BET = 10000                # 最大彩头
    WINNER_MULTIPLIER = 1.8        # 赢家获得1.8倍彩头
...
# 注意：percent_min/percent_max 是百分比（0.02 = 2%），基于总资产（金币+妖牛券）计算
# =============================================================================
FLY_PLANE_EVENTS = [
    # 低收益 (2%-5%)
    {"desc": "牛牛没赶上飞机，不过也算出来透了口气", "percent_min": 0.02, "percent_max": 0.04},
    {"desc": "牛牛刚出来就遇到了冷空气，冻得像个鹌鹑似的", "percent_min": 0.03, "percent_max": 0.05},
    {"desc": "飞机延误了，牛牛在候机厅睡着了", "percent_min": 0.02, "percent_max": 0.035},
    {"desc": "牛牛坐的是廉价航空，腿都伸不开", "percent_min": 0.025, "percent_max": 0.04},
    {"desc": "牛牛被安检拦下来检查了半天", "percent_min": 0.02, "percent_max": 0.03},
    {"desc": "牛牛的行李丢了，只能空手而归", "percent_min": 0.015, "percent_max": 0.025},
    # 中等收益 (5%-8%)
    {"desc": "无惊无险，牛牛顺利抵达目的地", "percent_min": 0.06, "percent_max": 0.075},
    {"desc": "牛牛好像到奇怪的地方，不过也算是完成了目标", "percent_min": 0.055, "percent_max": 0.07},
    {"desc": "牛牛在飞机上认识了新朋友，收获颇丰", "percent_min": 0.06, "percent_max": 0.08},
    {"desc": "飞行途中牛牛看了三部电影，心情愉悦", "percent_min": 0.05, "percent_max": 0.065},
    {"desc": "牛牛幸运地被升舱到商务舱", "percent_min": 0.065, "percent_max": 0.08},
    {"desc": "牛牛在免税店血拼了一番", "percent_min": 0.055, "percent_max": 0.075},
    {"desc": "空姐对牛牛特别照顾，全程VIP待遇", "percent_min": 0.06, "percent_max": 0.08},
    # 高收益 (8%-13%)
    {"desc": "竟然赶上了国际航班，遇到了兴奋的大母牛", "percent_min": 0.085, "percent_max": 0.11},
    {"desc": "竟然赶上了本地航班，遇到了兴奋的大公牛", "percent_min": 0.085, "percent_max": 0.11},
    {"desc": "牛牛意外发现飞机上有隐藏任务，奖励丰厚", "percent_min": 0.09, "percent_max": 0.12},
    {"desc": "牛牛被选中参加机上抽奖，中了大奖！", "percent_min": 0.10, "percent_max": 0.13},
    {"desc": "牛牛帮助空乘解决了紧急情况，获得感谢奖励", "percent_min": 0.085, "percent_max": 0.105},
    {"desc": "牛牛在头等舱偶遇神秘富婆，收获满满", "percent_min": 0.095, "percent_max": 0.12},
    {"desc": "飞机经过百慕大三角，牛牛获得了神秘力量加持", "percent_min": 0.08, "percent_max": 0.10},
    # 特殊事件 (8%-12%)
    {"desc": "牛牛的飞机迫降在无人岛，意外发现宝藏！", "percent_min": 0.08, "percent_max": 0.10},
    {"desc": "牛牛成功阻止了一场劫机，成为英雄！", "percent_min": 0.09, "percent_max": 0.11},
    {"desc": "牛牛买的机票中了航空公司年度大奖！", "percent_min": 0.10, "percent_max": 0.12},
    {"desc": "牛牛不小心走进了驾驶舱，被机长收为徒弟", "percent_min": 0.07, "percent_max": 0.09},
    {"desc": "牛牛的座位下面发现了前乘客遗落的金条", "percent_min": 0.09, "percent_max": 0.11},
    # 搞笑事件
    {"desc": "牛牛把花生米当成了安眠药，睡了一路", "percent_min": 0.04, "percent_max": 0.055},
    {"desc": "牛牛和邻座大妈聊了一路，耳朵都快聋了", "percent_min": 0.035, "percent_max": 0.05},
    {"desc": "牛牛在飞机上拉肚子，厕所排了半小时队", "percent_min": 0.025, "percent_max": 0.04},
    {"desc": "牛牛被小孩踢了一路椅背，精神损失惨重", "percent_min": 0.03, "percent_max": 0.045},
    {"desc": "牛牛旁边坐了个打呼噜的，一路没睡着", "percent_min": 0.035, "percent_max": 0.05},
    {"desc": "牛牛手机没电了，整趟航班只能发呆", "percent_min": 0.03, "percent_max": 0.045},
    # 终极事件 (10%-15%)
    {"desc": "✈️ 牛牛的飞机穿越到了平行宇宙，带回了另一个世界的财富！", "percent_min": 0.10, "percent_max": 0.13},
    {"desc": "👑 牛牛意外成为航空公司第一亿名乘客，获得终身免费机票+巨额奖金！", "percent_min": 0.12, "percent_max": 0.15},
    # 负面事件 (扣钱 -5%到-20%)
    {"desc": "💸 牛牛在飞机上打翻了红酒，赔了一大笔清洁费", "percent_min": -0.08, "percent_max": -0.05},
    {"desc": "🚨 牛牛被发现超重行李，被罚款了", "percent_min": -0.06, "percent_max": -0.03},
    {"desc": "💀 牛牛不小心损坏了座椅屏幕，要赔偿！", "percent_min": -0.10, "percent_max": -0.06},
    {"desc": "🎰 牛牛在飞机上玩牌输了，输给别牛一条裤子", "percent_min": -0.12, "percent_max": -0.07},
    {"desc": "🤮 牛牛晕机吐在了邻座身上，被索赔干洗费", "percent_min": -0.05, "percent_max": -0.02},
    {"desc": "📱 牛牛的手机掉进马桶里了，损失惨重", "percent_min": -0.07, "percent_max": -0.04},
    {"desc": "🚔 牛牛下飞机时被税务局拦住，补交了一大笔税", "percent_min": -0.10, "percent_max": -0.06},
    {"desc": "💔 牛牛被空姐发了好牛卡，精神和金钱双重损失", "percent_min": -0.04, "percent_max": -0.02},
    {"desc": "🦠 牛牛在飞机上感染了牛感，医药费花光了积蓄", "percent_min": -0.10, "percent_max": -0.05},
    {"desc": "⚠️ 牛牛误触紧急出口，被罚了巨款！", "percent_min": -0.10, "percent_max": -0.06},
    # === 新增搞怪事件 ===
    # 奇遇正面
    {"desc": "🎭 牛牛被误认为是某明星，收到粉丝送的礼物", "percent_min": 0.07, "percent_max": 0.095},
    {"desc": "🎪 牛牛在飞机上表演了一段才艺，乘客们纷纷打赏", "percent_min": 0.06, "percent_max": 0.085},
    {"desc": "🧲 牛牛在座位缝里发现了别牛落下的钱包（已归还，失主给了感谢费）", "percent_min": 0.08, "percent_max": 0.11},
    {"desc": "🎮 牛牛和邻座押宝猜飞行时间，赢了！", "percent_min": 0.05, "percent_max": 0.07},
    {"desc": "🌈 牛牛在高空看到了极光，拍照发朋友圈收获无数点赞和打赏", "percent_min": 0.055, "percent_max": 0.075},
    {"desc": "🎁 牛牛是今天第888位乘客，获得幸运礼包", "percent_min": 0.06, "percent_max": 0.088},
    {"desc": "🐾 牛牛帮一位老奶奶找到了走丢的小狗，获得丰厚酬谢", "percent_min": 0.065, "percent_max": 0.09},
    {"desc": "🎤 机长竟然是牛牛的老同学，直接安排头等舱待遇", "percent_min": 0.09, "percent_max": 0.12},
    {"desc": "🍀 牛牛发现座椅口袋里有上一位乘客忘记领的刮刮乐，中了！", "percent_min": 0.07, "percent_max": 0.10},
    {"desc": "🎯 牛牛精准预测了航班到达时间，航空公司奖励积分兑换现金", "percent_min": 0.045, "percent_max": 0.065},
    {"desc": "🦸 牛牛帮空姐制服了一个闹事乘客，获得英雄奖励", "percent_min": 0.07, "percent_max": 0.10},
    {"desc": "📺 航班娱乐系统故障，牛牛用手机给大家放电影，收到感谢费", "percent_min": 0.04, "percent_max": 0.06},
    {"desc": "🧩 牛牛在飞机上完成了一个超难拼图，邻座土豪觉得有趣买下了它", "percent_min": 0.075, "percent_max": 0.10},
    {"desc": "🎂 今天是牛牛生日，机组送上惊喜蛋糕和生日礼金", "percent_min": 0.08, "percent_max": 0.11},
    {"desc": "💤 牛牛睡着后说梦话，竟然说中了彩票号码！（邻座分红）", "percent_min": 0.08, "percent_max": 0.11},
    # 搞笑中性偏正
    {"desc": "🐔 牛牛的飞机餐居然是满汉全席？原来是厨师搞错了", "percent_min": 0.05, "percent_max": 0.07},
    {"desc": "👻 牛牛假装睡着躲过了推销信用卡的空姐，省下时间刷副业", "percent_min": 0.035, "percent_max": 0.055},
    {"desc": "🎵 牛牛耳机坏了，只能听飞机引擎声，竟然悟出了新的赚钱思路", "percent_min": 0.06, "percent_max": 0.085},
    {"desc": "🤡 牛牛把安全演示看成了喜剧表演，笑出了腹肌", "percent_min": 0.03, "percent_max": 0.05},
    {"desc": "🌙 牛牛在飞机上做了个发财梦，醒来发现真的有人给自己转账了", "percent_min": 0.07, "percent_max": 0.10},
    {"desc": "📖 牛牛看完了一本理财书，下飞机立刻赚到了第一桶金", "percent_min": 0.055, "percent_max": 0.08},
    {"desc": "🎲 牛牛和空少玩石头剪刀布，连赢十局获得神秘奖品", "percent_min": 0.065, "percent_max": 0.09},
    {"desc": "🧘 牛牛在飞机上冥想，悟到了人生的真谛（顺便接了个私单）", "percent_min": 0.045, "percent_max": 0.07},
    # 搞笑负面
    {"desc": "🦷 牛牛吃飞机餐太猛，把假牙吞下去了，医疗费爆表", "percent_min": -0.09, "percent_max": -0.05},
    {"desc": "🎪 牛牛在飞机上放了个响屁，被要求换座+精神损失费", "percent_min": -0.03, "percent_max": -0.01},
    {"desc": "👔 牛牛西装被邻座小孩画满了蜡笔画，干洗费感人", "percent_min": -0.045, "percent_max": -0.025},
    {"desc": "🍷 牛牛喝多了在飞机上唱歌，被罚款扰民费", "percent_min": -0.055, "percent_max": -0.03},
    {"desc": "🎭 牛牛模仿机长广播被投诉，赔礼道歉+罚款", "percent_min": -0.07, "percent_max": -0.04},
    # 神秘事件
...
DEFAULT_SHOP_ITEMS = [
    {
        ...
        'name': "含笑五步癫",
        'type': 'active',
        'desc': "自爆！消耗你100%总资产(含妖牛券,底价10亿)！目标每次行动损失快照值19.6%，走5步共98%，第1步损失转移给你作为回报，第2-5步直接销毁，无法抵挡！用法：牛牛购买 0 @目标",
        'price': 0,
        'dynamic_price': True
    },
    {
    ...
    },
    {
        ...
        'name': "祸水东引",
        'type': 'active',
        'desc': "获得1次转嫁：>=50cm长度伤害或>=50金币抢劫转给随机群友！（无法转移夺牛魔）",
        'price': 125
    },
    {
        'id': 15,
    ...
    },
    {
        ...
        'name': "牛牛重锤",
        'type': 'active',
        'desc': "指定目标，每个重锤击破5层护盾（不足5层直接清零）！支持批量购买。用法：牛牛购买 22 @目标 [数量]",
        'price': 800
    },
]
...
# 牛牛重锤 Configuration
# =============================================================================
class ChongchuiConfig:
    SHIELD_BREAK_PER_USE = 5           # 每个重锤击破5层护盾

# =============================================================================
# 穷牛一生 Configuration (期望值略正的押宝道具)
# =============================================================================
...
# =============================================================================
#
# 「含笑五步癫」是一个终极打击道具，具有极高的代价和毁灭性的效果。
#
# ==================== 使用条件 ====================
# 1. 购买者需要有至少 10亿 总资产（金币 + 妖牛券市值）
# 2. 必须指定一个目标（@某人）
# 3. 不能对自己使用
#
# ==================== 购买代价 ====================
# 消耗规则：扣除购买者 100% 的总资产（金币 + 妖牛券市值），最低 10亿
#   - 计算公式：cost = max(10亿, 总资产 × 100%)
#   - 扣除顺序：先扣金币，金币不足时强制卖出妖牛券补足
#   - 妖牛券强制清算：被清算的妖牛券记为纯损失（不影响牛价，无任何收益）
#
# ==================== 含笑五步癫 机制 ====================
# 施加时记录快照：
#   - snapshot_length：目标被击时的长度绝对值
#   - snapshot_hardness：目标被击时的硬度
#   - snapshot_asset：目标被击时的总资产（金币 + 妖牛券市值）
#
# 每次触发效果（共 5 次，走5步）：
...
#   - 第1步的损失转移给发起方（长度+硬度+资产）
#   - 第2-5步的损失直接销毁
#
# 触发条件：
#   - 只有目标主动发送命令时触发（被动参与不算）
#   - 行动命令包括：打胶、比划、抢劫（成功或失败）、开冲、停止开冲、飞飞机、购买道具、买卖妖牛券等
#   - 非行动命令（如查看背包、排行榜、持仓）不触发
#   - 被比划、被抢劫等被动参与不触发
#
# 特点：
#   - 含笑五步癫效果无法被任何道具/效果抵挡
...
# ==================== 设计理念 ====================
# 这是一个自爆型终极打击道具：
# - 使用者倾家荡产（100%总资产，最低10亿）
# - 目标受到含笑五步癫持续伤害（5次 × 19.6%快照值 = 98%）
# - 第1步损失转移给发起方作为回报（19.6%快照值）
# - 第2-5步损失直接销毁
# - 伤害无法被任何道具抵挡
# - 目标资产越高，发起方回报越大（鼓励劫富）
#
class HanxiaoWubudianConfig:
    MIN_PLAYERS = 2                    # 最少需要2人（自己+1个目标）
    ASSET_CONSUME_PERCENT = 1.0        # 消耗100%总资产
    ...
    # 成功使用文案
    SUCCESS_TEXTS = [
        "😈 {user} 发动「含笑五步癫」！{target} 中了「含笑五步癫」！",
        "🤪 {user} 自爆全部身家，对 {target} 使出禁术「含笑五步癫」！",
    ...
    INSUFFICIENT_ASSET_TEXTS = [
        "❌ 你的总资产不足10亿！「含笑五步癫」需要至少10亿金币的代价！",
        "❌ 穷牛使不出「含笑五步癫」！攒够10亿再来吧！",
        "❌ 「含笑五步癫」是超级富牛的专属！你的资产：{asset}，需要：10亿",
    ]
...
class StockTaxConfig:
    ...
    TAX_BRACKETS = [
        ...
        (5, 0.40),     # 3-5倍：40%
        (10, 0.55),    # 5-10倍：55%
        (20, 0.70),    # 10-20倍：70%（超高暴利重税）
        (float('inf'), 0.85),  # 20倍以上：85%（极端暴利）
    ]
...
class BainianConfig:
    ...
    FU_ASSET_BONUS_PERCENT = 0.50  # 额外奖励：总资产（金币+妖牛券市值）的50%
