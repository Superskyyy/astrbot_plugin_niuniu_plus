...
FLY_PLANE_EVENTS = [
    ...
    # 特殊事件 (12%-20%)
    {"desc": "牛牛的飞机迫降在无人岛，意外发现宝藏！", "percent_min": 0.12, "percent_max": 0.15},
    {"desc": "牛牛成功阻止了一场劫机，成为英雄！", "percent_min": 0.13, "percent_max": 0.16},
    {"desc": "牛牛买的机票中了航空公司年度大奖！", "percent_min": 0.15, "percent_max": 0.20},
    {"desc": "牛牛不小心走进了驾驶舱，被机长收为徒弟", "percent_min": 0.10, "percent_max": 0.14},
    {"desc": "牛牛的座位下面发现了前乘客遗落的金条", "percent_min": 0.14, "percent_max": 0.18},
    # 搞笑事件
    ...
    # 终极事件 (25%-40%)
    {"desc": "✈️ 牛牛的飞机穿越到了平行宇宙，带回了另一个世界的财富！", "percent_min": 0.25, "percent_max": 0.35},
    {"desc": "👑 牛牛意外成为航空公司第一亿名乘客，获得终身免费机票+巨额奖金！", "percent_min": 0.30, "percent_max": 0.40},
    # 负面事件 (扣钱 -5%到-20%)
    ...
    {"desc": "🎁 牛牛是今天第888位乘客，获得幸运礼包", "percent_min": 0.088, "percent_max": 0.128},
    ...
    {"desc": "🍀 牛牛发现座椅口袋里有上一位乘客忘记领的刮刮乐，中了！", "percent_min": 0.10, "percent_max": 0.15},
    {"desc": "🎯 牛牛精准预测了航班到达时间，航空公司奖励积分兑换现金", "percent_min": 0.045, "percent_max": 0.065},
    {"desc": "🦸 牛牛帮空姐制服了一个闹事乘客，获得英雄奖励", "percent_min": 0.11, "percent_max": 0.14},
    ...
    {"desc": "💤 牛牛睡着后说梦话，竟然说中了彩票号码！（邻座分红）", "percent_min": 0.12, "percent_max": 0.16},
    # 搞笑中性偏正
    ...
    {"desc": "🎰 牛牛在飞机上刮彩票，三等奖！", "percent_min": 0.15, "percent_max": 0.20},
    {"desc": "🗝️ 牛牛在洗手间捡到一把神秘钥匙，后来发现是某个寄存柜的", "percent_min": 0.18, "percent_max": 0.25}
]
...
DEFAULT_SHOP_ITEMS = [
    {
        ...
        'name': "化牛绵掌",
        'type': 'active',
        'desc': "消耗你99%总资产(含股票,底价10亿)！对目标施加「含笑五步癫」：记录目标当前的长度/硬度/总资产作为快照，之后目标每次主动行动**完成后**（打胶/比划/抢劫/买卖等）都会损失快照值的19.6%，走5步共损失98%，资产先扣金币再强卖股票，效果无法被任何道具抵挡！用法：牛牛购买 0 @目标",
        'price': 0,
        'dynamic_price': True
    },
    {
