...
# 注意：percent_min/percent_max 是百分比（0.02 = 2%），基于总资产（金币+股票）计算
# =============================================================================
FLY_PLANE_EVENTS = [
    # 低收益 (2%-5%)
    ...
    {"desc": "🎮 牛牛和邻座打赌猜飞行时间，赢了！", "percent_min": 0.05, "percent_max": 0.07},
...
DEFAULT_SHOP_ITEMS = [
    {
        ...
        'name': "含笑五步癫",
        'type': 'active',
        'desc': "自爆！消耗你100%总资产(含股票,底价10亿)！目标每次行动损失快照值19.6%，走5步共98%，第1步损失转移给你作为回报，第2-5步直接销毁，无法抵挡！用法：牛牛购买 0 @目标",
        'price': 0,
        'dynamic_price': True
    },
    {
...
#
# ==================== 购买代价 ====================
# 消耗规则：扣除购买者 100% 的总资产（金币 + 股票市值），最低 10亿
...
#   - 行动命令包括：打胶、比划、抢劫（成功或失败）、开冲、停止开冲、飞飞机、购买道具、买卖股票等
