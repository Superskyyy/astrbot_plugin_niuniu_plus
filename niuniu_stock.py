...
EVENT_TEMPLATES = {
    "dajiao": {
        "up": [
            ...
            "📈 {nickname} 勤劳打胶，巴菲特点赞",
            "📈 {nickname} 的手速带动了牛价",
            "📈 {nickname} 打出了新高度，牛民狂喜",
            "📈 {nickname} 一发入魂！妖牛股应声上涨",
            "📈 打胶打出GDP，{nickname} 功不可没",
            "📈 {nickname} 的牛牛带动经济复苏",
            "📈 专家称{nickname}打胶有利于妖牛市健康",
            "📈 {nickname} 打胶的姿势很标准，牛价认可",
            "📈 热搜：{nickname} 打胶引发牛市",
            "📈 {nickname} 打得好！散户跟风买入",
            "📈 {nickname} 的努力被市场看见了",
            "📈 「打胶兴邦」—— {nickname}",
            ...
            "📈 「打胶一小步，牛价一大步」—— {nickname}",
            "📈 {nickname} 的牛牛成为市场风向标",
        ],
        "down": [
            "📉 {nickname} 打胶缩水 {change}cm，牛民心凉",
            "📉 {nickname} 打胶翻车，散户割肉",
            "📉 {nickname} 的失误让妖牛市蒙羞",
            "📉 {nickname} 打了个寂寞，牛价应声下跌",
            "📉 {nickname} 手滑了？妖牛股暴跌！",
    ...
    "compare": {
        "up": [
            ...
            "📈 {nickname} 碾压对手，妖牛股狂飙",
            "📈 一场精彩比划，牛价直冲云霄",
            "📈 {nickname} 的牛牛太强了，妖牛市沸腾",
            "📈 {nickname} 赢得漂亮！机构疯狂买入",
            "📈 {nickname} 用实力证明了牛牛的价值",
            "📈 {nickname} 的胜利提振了市场信心",
            "📈 史诗级对决！{nickname} 获胜，牛价新高",
            "📈 {nickname} 一战成名，妖牛券涨停！",
            "📈 {nickname} 的牛牛震慑全场，牛价应声上涨",
            "📈 「这就是实力」—— {nickname}",
            ...
            "📈 「比划王者」{nickname} 带飞牛价",
            "📈 {nickname} 的胜利让空头瑟瑟发抖",
            "📈 {nickname} 赢得毫无悬念，牛价涨得理所当然",
            "📈 {nickname} 的牛牛就是市场的定海神针",
            "📈 {nickname} 获胜！游资：买买买！",
            "📈 {nickname} 用牛牛创造了新的历史",
            "📈 「{nickname} 赢了，我们都赢了」—— 牛民",
            "📈 {nickname} 的胜利是对妖牛市最好的激励",
            "📈 {nickname} 一骑绝尘，牛价跟着绝尘",
        ],
        "down": [
            "📉 {nickname} 比划惨败，妖牛市一片绿",
            "📉 {nickname} 被对手碾压，牛民哭晕",
            "📉 惨烈比划！{nickname} 落败，牛价跳水",
            "📉 {nickname} 的牛牛不争气，妖牛市崩盘",
            "📉 {nickname} 输得太惨，机构清仓跑路",
            "📉 {nickname} 的失败打击了市场信心",
            "📉 「菜就多练」—— 市场对{nickname}的评价",
            "📉 {nickname} 被暴打，牛价被暴打",
            "📉 {nickname} 的牛牛丢人了，牛价跟着丢",
            "📉 {nickname} 惨遭碾压，散户：润了润了",
            "📉 {nickname} 输麻了，妖牛股也输麻了",
            "📉 {nickname} 的比划表演令人失望",
            "📉 {nickname} 被教做人，牛价被教做股",
            "📉 {nickname} 的硬度不够硬，牛价不够挺",
            "📉 {nickname} 输了，牛民的心也碎了",
            "📉 {nickname} 比划输了，输傻了！",
            "📉 「比划青铜」{nickname} 拖累牛价",
            "📉 {nickname} 的失败让多头绝望",
            "📉 {nickname} 输得毫无悬念，牛价跌得理所当然",
            "📉 {nickname} 的牛牛就是市场的定时炸弹",
            "📉 {nickname} 落败！游资：跑跑跑！",
            "📉 {nickname} 用牛牛创造了新的耻辱",
            "📉 「{nickname} 输了，我们都输了」—— 牛民",
            "📉 {nickname} 的失败是对妖牛市最大的打击",
            "📉 {nickname} 一败涂地，牛价跟着涂地",
        ],
    },
    "item": {
        "up": [
            "📈 {nickname} 使用道具血赚！妖牛市疯狂",
            "📈 道具效果逆天！{nickname} 带飞牛价",
            "📈 {nickname} 的操作秀翻全场，牛价起飞",
            "📈 {nickname} 用道具创造奇迹！",
            "📈 {nickname} 的道具选择很明智，妖牛市认可",
            "📈 「科技改变命运」—— {nickname}",
            "📈 {nickname} 氪金成功，牛价跟着成功",
            "📈 道具在手，{nickname} 说涨就涨",
            "📈 {nickname} 的道具让市场刮目相看",
            "📈 {nickname} 用道具征服了妖牛股",
            "📈 {nickname} 的神操作引发跟风买入",
            "📈 道具玩得好，{nickname} 带动牛价跑",
            "📈 {nickname} 的道具带来了财富效应",
            "📈 {nickname} 道具开挂，牛价跟着开挂",
            "📈 {nickname} 被评为「道具之王」，牛价点赞",
            "📈 {nickname} 的道具技术登峰造极",
            "📈 「充钱使我变强」—— {nickname} 的成功秘诀",
            "📈 {nickname} 用道具打开了财富之门",
            "📈 道具商城感谢{nickname}的鼎力支持",
            "📈 {nickname} 的道具操作堪称教科书",
            "📈 {nickname} 用道具改写了妖牛市走向",
            "📈 「道具就是生产力」—— {nickname}",
            "📈 {nickname} 的道具让对手瑟瑟发抖",
            "📈 {nickname} 靠道具逆天改命",
            "📈 {nickname} 的氪金实力令人敬畏",
        ...
        "down": [
            "📉 {nickname} 道具翻车！牛民心态崩了",
            "📉 道具反噬！{nickname} 拖累妖牛市",
            "📉 {nickname} 的操作堪称灾难，牛价暴跌",
            "📉 {nickname} 用道具搞砸了一切",
            "📉 「这钱花得不值」—— {nickname}",
            "📉 {nickname} 的道具成了妖牛市毒药",
            "📉 {nickname} 氪金失败，牛价跟着失败",
            "📉 道具在手，{nickname} 说跌就跌",
            "📉 {nickname} 的道具让市场失望透顶",
            "📉 {nickname} 用道具毁灭了希望",
            "📉 {nickname} 的骚操作引发恐慌抛售",
    ...
    "global": {
        "up": [
            ...
            "🌍 {nickname} 的操作载入史册",
            "🌍 大事件触发，牛民集体高潮",
            "🌍 {nickname} 成为今日MVP，牛价致敬",
            "🌍 「一人得道，牛价升天」",
            "🌍 {nickname} 的壮举让妖牛市起立鼓掌",
            "🌍 全局事件利好！涨疯了！",
            "🌍 {nickname} 触发隐藏剧情，牛价暴涨",
            "🌍 「见证历史」—— 妖牛股新高",
            "🌍 {nickname} 的操作被写入教科书",
            "🌍 「{nickname} 拯救了我们」—— 全体牛民",
            "🌍 {nickname} 用一己之力撬动妖牛市",
            ...
            "🌍 {nickname} 改变世界，牛价改变命运",
            "🌍 「今天，我们都是{nickname}」",
            "🌍 {nickname} 的传奇将被永远铭记",
        ],
        "down": [
            "🌍 全局事件冲击！牛价原地去世",
            "🌍 {nickname} 的操作震动全局，震碎牛价",
            "🌍 灾难性事件！妖牛股跳水",
            "🌍 {nickname} 毁灭了整个群的希望",
            "🌍 「黑色一刻」—— 今日妖牛市",
            "🌍 {nickname} 创造历史，牛价创新低",
            ...
            "🌍 {nickname} 的操作遗臭万年",
            "🌍 大事件触发，牛民集体emo",
            "🌍 {nickname} 成为今日罪人，牛价唾弃",
            "🌍 「一人作死，牛价遭殃」",
            "🌍 {nickname} 的壮举让妖牛市鸦雀无声",
            "🌍 全局事件利空！跌惨了！",
            "🌍 {nickname} 触发毁灭剧情，牛价暴跌",
            "🌍 「见证历史」—— 妖牛股新低",
            "🌍 {nickname} 的操作被写入黑历史",
            "🌍 「{nickname} 害惨了我们」—— 全体牛民",
            "🌍 {nickname} 用一己之力砸穿妖牛市",
...
class NiuniuStock:
    ...
    def bailout(self, group_id: str, coins: float, operator: str = None) -> Tuple[bool, str]:
        ...
        return True, (
            ...
            f"{price_symbol} 牛价变动: {old_price:.2f} → {new_price:.2f} ({change_str})\n"
            f"═══════════════════════\n"
            f"{success_text}"
        )
...
def stock_hook(group_id: str,
    ...
    所有游戏事件都应调用此函数，妖牛市会根据事件类型和变化量更新牛价
